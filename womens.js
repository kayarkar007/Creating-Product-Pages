var womensData = [
  ...
  function displayPage(womensData){
   ...
   for(let i=0;i<womensData.length;i++){
       ...
       imageTag.src=womensData[i].image_url;
       let h4= document.createElement("h1");
       h4.innerText=womensData[i].name;
       let p= document.createElement("p");
       p.innerText=womensData[i].price;
       let p1=document.createElement("p");
       p1.className="strikeOff";
       p1.innerText=womensData[i].strikedoffprice;
       let button=document.createElement("button");
       button.innerText="Add to Cart"
       divTag1.append(imageTag,h4,p,p1,button);
